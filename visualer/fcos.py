...
class FCOSHead(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        return logits, bbox_reg, centerness, cls_towers, box_towers
...
class FCOSModule(torch.nn.Module):
    ...
    def __init__(self, cfg, in_channels):
        ...
        self.head = head
        self.fpn_strides = cfg.MODEL.FCOS.FPN_STRIDES
        self.post = make_fcos_loss_evaluator(cfg)
    ...
    def forward(self, images, features, targets=None):
        ...
        """
        box_cls, box_regression, centerness, clses, bboxes = self.head(features)
